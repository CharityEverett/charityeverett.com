...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* <section className="bg-black text-white py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-light text-center mb-16 tracking-[0.2em]">CONTACT</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-transparent border-b border-gray-600 py-2 px-0 text-white focus:border-white focus:outline-none transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className="w-full bg-transparent border-b border-gray-600 py-2 px-0 text-white focus:border-white focus:outline-none transition-colors resize-none"
                  />
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-600">Attachments (0)</span>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 w-4 h-4 bg-transparent border border-gray-600 rounded focus:ring-white focus:ring-1"
                  />
                  <label htmlFor="subscribe" className="text-gray-400 text-sm leading-relaxed">
                ...
                <button
                  ...
                  className="w-full bg-white text-black py-4 rounded-full text-sm tracking-[0.2em] font-medium hover:bg-gray-100 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="flex-shrink-0 lg:w-80">
              <h3 className="text-2xl font-light mb-8">Charity Everett</h3>
            </div>
          </div>
        </div>
      </section> */}
